...
Clip = true
    ...
    Credits:AddLabel('miabladi#6279 - owner/developer')
    Credits:AddLabel('wussownsfoxxy#1241 - HELPED A BIT WITH ESP')
    ...
    notify('TAY.XYZ loaded in '..tostring(tick() - load)..'ms')
